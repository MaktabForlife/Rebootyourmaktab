/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=development src/worker-configuration.d.ts` (hash: fcf76dae3c51175b8e67866b1f5c5bbb)
// Runtime types generated with workerd@1.20260921.1 2026-06-01
interface __BaseEnv_Env {
	MEDIA_BUCKET: R2Bucket;
	AUTH_LOGIN_RATE_LIMITER: RateLimit;
	PROGRAM_TIMETABLE_COORDINATOR: DurableObjectNamespace<import("./worker-runtime").ProgramTimetableCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker-runtime");
		durableNamespaces: "ProgramTimetableCoordinator";
	}
